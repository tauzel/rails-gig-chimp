...
Student.create!(username: 'henrialb', name: 'Henrique Albuquerque', picture_url: 'https://kitt.lewagon.com/placeholder/users/henrialb', opt_in: 1, description: "Curious mind who likes to build stuff that makes life easier. Amateur athlete, lover of music and photography, eager to learn. Better by the sea.", batch: '683')
