...
Student.create!(username: 'henrialb', name: 'Henrique Albuquerque', picture_url: 'https://kitt.lewagon.com/placeholder/users/henrialb', opt_in: 1, description: "Curious mind who likes to build stuff that makes life easier. Amateur athlete, lover of music and photography, eager to learn. Better by the sea.", batch: '683', location: 'Lisboa')
Student.create!(username: 'tauzel', name: 'Thierry Auzel', picture_url: 'https://kitt.lewagon.com/placeholder/users/tauzel', opt_in: 1, description: "I'm French, grew up in Paris region. Experience in Finance in Paris & London (M&A & Private Equity). Lived in Paris, London, Hong Kong (exchange student) and Shanghai. In my job I tried my hand on some patchwork vba code. Always wanted to learn coding and now is the time ! I hope it will help me make automate a number of things at my job to help my colleagues and I spend more time on thinking and less on robotic tasks.", batch: '683', location: 'Lisboa')
Student.create!(username: 'ratzan', name: 'Pedro Rato', picture_url: 'https://kitt.lewagon.com/placeholder/users/ratzan', opt_in: 1, description: "I am a Translation student looking to get started in a new area and expand my knowledge, hoping to connect with like minded individuals and learn from each other.", batch: '683', location: 'Lisboa')
Student.create!(username: 'ArturRenzenbrink', name: 'Artur Renzenbrink', picture_url: 'https://kitt.lewagon.com/placeholder/users/ArturRenzenbrink', opt_in: 1, description: "Hello I am currently a Student(double bachelor in BBA and Data Analytics) learning web development at le wagon. I am from Hamburg, Germany but currently live in Madrid, Spain", batch: '683', location: 'Lisboa')
Student.create!(username: 'catiafalagueira', name: 'Cátia Falagueira', picture_url: 'https://kitt.lewagon.com/placeholder/users/catiafalagueira', opt_in: 1, description: "I worked as a Visual merchandising and Trainer coach in fashion industry. For me it's important to have balance in my life (personal life and professional). Learn to code is an opportunity to expand myself, be more flexible and create the life i want to live.", batch: '683', location: 'Lisboa')
Student.create!(username: 'louro-ines', name: 'Inês Louro', picture_url: 'https://kitt.lewagon.com/placeholder/users/louro-ines', opt_in: 1, description: "I have a Business Management Degree and a Human Resources Management Master's Degree and I've previously worked as a Quality Manager. I've wanted to learn to code to be able to change my career path and work as a developer.", batch: '683', location: 'Lisboa')
Student.create!(username: 'David2Luis', name: 'David Mendes Luís', picture_url: 'https://kitt.lewagon.com/placeholder/users/David2Luis', opt_in: 1, description: "David Luís 26 years old From: Lisbon, Portugal Just a retired triathlete trying to find a new challenging live style. I wanted to learn code for a while and now it's the time for that.", batch: '683', location: 'Lisboa')
Student.create!(username: 'macafadeal', name: 'Mateus Albuquerque', picture_url: 'https://kitt.lewagon.com/placeholder/users/macafadeal', opt_in: 1, description: "Wed 28 Jul 2021 I'm a Brazilian student who has lived abroad from the age of 7. I've lived in Dubai, Madrid, and am now based in Lisbon. Furthermore, I have completed my high school education successfully, and have attempted 3 separate Bachelor's degrees in Informatics Engineering & Video game Design (UEM) and Sociology (ISCTE-IUL), but have dropped out from all of them due to personal struggles and dissatisfaction with the courses, mostly due to their general orientation towards research as opposed to practicality and working skills. For these reasons, I have opted to join Le Wagon and pursuit a career in IT programming, and aspire to make a main career out of this profession.", batch: '683', location: 'Lisboa')
Student.create!(username: 'marianadkobayashi', name: 'Mariana Kobayashi', picture_url: 'https://kitt.lewagon.com/placeholder/users/marianadkobayashi', opt_in: 1, description: "I have a Double Bsc in Economics and International Business and a passion for the tech world. As for the future, I hope to work in digital venture creation.", batch: '683', location: 'Lisboa')
Student.create!(username: 'G-Souza-99', name: 'Gabriel Souza', picture_url: 'https://kitt.lewagon.com/placeholder/users/G-Souza-99', opt_in: 1, description: "Student as IT Business Management. From Portugal, always studied in English. Joined Le Wagon to expand my knowledge in the area after gently touching the subject at uni.", batch: '683', location: 'Lisboa')
Student.create!(username: 'Ajguerra28', name: 'António Guerra', picture_url: 'https://kitt.lewagon.com/placeholder/users/Ajguerra28', opt_in: 1, description: "I've studied programming in highschool but never continued to practice what i've learned. I want to learn coding so I can work on something I really like to do. After Le Wagon I wan't to gather experience in the field so I can open a IT Consultant later.", batch: '683', location: 'Lisboa')
...
50.times do |i|
  ...
  Student.create!(username: username, name: name, picture_url: picture, opt_in: 1, description: description, batch: batch, location: location)
